...
int main() {
  ...
  console.clear();
  int r = 10;
  console.display("Name: ", 3, 5);
  console.display((char*)FCL[nameIx].data(),3, 12);
  console.display("Phone: ", 4, 5);
  console.display((char*)FCL[phoneIx].data(), 4, 13);
  for(unsigned int i=0;i<cl.length();i++){
    console.display((bool)cl[i]?"Checked:":"Not Checked:", r+i, 5, 13); 
    console.display((char*)cl[i],r+i, 19); 
  }
  console.display("Press any key to exit....", console.getRows()-2, 5);
  console.pause();
  return 0;
}
