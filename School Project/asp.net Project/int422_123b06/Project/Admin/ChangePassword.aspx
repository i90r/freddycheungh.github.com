<%@ Page Title="" Language="C#" MasterPageFile="~/Project/Masterpages/admin.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="int422_123b06.Project.Admin.ChangePassword" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
        Current Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="tbCurPwd" runat="server" TextMode="Password"></asp:TextBox>
